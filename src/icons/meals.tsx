...
export const MealsIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({
    width=40,
    height=40,
    stroke='#000000',
    ...props
    ...
    return (
        <svg width={width} height={height} {...props} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd">
            <path
